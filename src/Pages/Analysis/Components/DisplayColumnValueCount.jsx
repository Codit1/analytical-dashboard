...
function DisplayColumnValueCount() {
    return (
        <div className='bg-white p-2 rounded-md'>

            <div className='flex items-center justify-end'>
                <Select
                    label="Select Column to see Value Count"
                    placeholder="column"
            ...
            <div>
                <Text fw={"bold"} fz={"lg"}>Value Count in <span className='text-slate-400'>Tranmission</span> Column</Text>
            </div>
...
export default DisplayColumnValueCount
